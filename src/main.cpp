...
float temp = 20; // Sollwert Raumtemperatur
float COx = 0;
float voltage = 0;
float tAusNacht = 20.00;
float tOnTag = 03.00;
float CO2 = 0;
// char input;
...
<form action="/get">    
Temperartur: <br>
<input type="number" step="0.01" name="input1"><br>
Tag: <br>
<input type="number" step="0.01" name="input2"><br>
Nacht: <br>
<input type="number" step="0.01" name="input3"><br>
<input type="submit" value="Submit">
...
// Fuer SD-CardReader funktioniert nicht
/*
...
// Write point
  pointDevice.addField("temp", temperatur);
  
  pointDevice.addField("hum", huminity);
